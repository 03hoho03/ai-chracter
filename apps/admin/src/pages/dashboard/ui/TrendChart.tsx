...
/** 차트로 그릴 수 있는 지표 = 추이 응답에서 날짜를 뺀 필드들. 목록의 오타를 컴파일이 잡는다. */
type TrendMetricField = Exclude<keyof AdminDashboardTrendPoint, "date">;
...
] as const satisfies readonly { key: TrendMetricField; title: string; config: ChartConfig }[];

type TrendMetricKey = (typeof MINI_CHARTS)[number]["key"];
