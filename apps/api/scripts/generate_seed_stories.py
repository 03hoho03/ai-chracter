...
후가 아니라 생성 전에 막을 수 있다. 그래서 LLM 출력 스키마에는 아예 제목·한줄·
...
한 장르를 다 만든 뒤에는 **유사도 게이트**가 그 장르 전체를 한 번에 심사한다. 좌표는
...
def build_prompt(
    ...
    """5단 구조 — 역할·제약 / 좌표와 콘셉트 / 누적 컨텍스트 / 구조 요건 / 출력 스키마."""
    sections = [
