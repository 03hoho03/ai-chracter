...
class UserPersona(Base):
    """persona-goal-prompt.md §3-1 (UP-2·UP-3). 유저의 "대화 프로필" — 유저당 최대 10개.

    길이·금지 문자(UP-5)와 성별 허용값(UP-4)은 요청 스키마가 강제한다 — 여기는 저장만 한다.
