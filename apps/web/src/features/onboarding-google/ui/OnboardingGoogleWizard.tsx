...
export function OnboardingGoogleWizard({ token }: OnboardingGoogleWizardProps) {
  ...
  // 스텝 분기를 평범한 함수로 뽑아 `FormProvider`가 두 갈래 모두를 한 번에 감싸게 한다
  ...
  function renderStep() {
    ...
    return <BasicInfoStep onSubmit={() => void handleBasicInfoSubmit()} isSubmitting={onboardingMutation.isPending} />;
  }
