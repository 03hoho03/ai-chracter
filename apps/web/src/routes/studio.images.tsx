...
// image-refact-goal-prompt.md IR-4 — 탭 값이 generate/transform/inpaint로 바뀌었다(library는 탭이
// 아니다, IR-5). 모르는 값은 그 축만 기본값(= 파라미터의 부재)으로 흘려보낸다 — `validateSearch`
// 8곳 공통 처방이라 .catch(undefined)를 유지한다.
